...
public class WorldMap {
    ...
    public boolean isWithinGoodHarvestArea(Vector2d grassPosition) {
        return grassPosition.getX()>=goodHarvestBottomLeft.getX() && grassPosition.getY()>=goodHarvestBottomLeft.getY() && grassPosition.getX()<goodHarvestBottomLeft.getX()+goodHarvestAreaWidth && grassPosition.getY()<goodHarvestBottomLeft.getY()+goodHarvestAreaWidth;
    }

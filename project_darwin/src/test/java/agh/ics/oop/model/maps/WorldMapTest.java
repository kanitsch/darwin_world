...
public class WorldMapTest {
    ...
    public void placeAnimalOnMap() {
        ...
        Constants constants = new Constants(0, 0, 0, 6, 4, false, false, 0, 5, 0, 0, 3, 0, 0,0);
    ...
    public void place2animalsAtTheSamePosition() {
        ...
        Constants constants = new Constants(0, 0, 0, 6, 4, true, false, 0, 5,  0, 0, 3, 0, 0,0);
        ConstantsList.addToConstantsList(0, constants);
    ...
    public void moveAnimal() {
        ...
        Constants constants = new Constants(1, 1, 0, 6, 4, true, false, 0, 5,  0, 0, 3, 0, 0,0);
        ConstantsList.addToConstantsList(0, constants);
        int[] genesList = {1};
    ...
    public void removeDeadAnimal() {
        ...
        Constants constants = new Constants(1, 1, 0, 6, 4, true, false, 0, 0,  0, 0, 0, 0, 0,0);
        ConstantsList.addToConstantsList(0, constants);
    ...
    public void someStatistics(){
        ...
        Constants constants = new Constants(1, 5, 0, 6, 4, true, false, 0, 5,  0, 0, 3, 3, 2,0);
        ConstantsList.addToConstantsList(0, constants);
...
//        map.animalsBreed();
    ...
    public void breedingOnMap(){
        ...
        map.place(animal2);
        map.animalsBreed();
        assertEquals(3,map.getTotalAnimals());
    }

    @Test
    public void growGrassTest(){

        Constants constants = new Constants(0, 0, 0, 10, 10, true, false, 0, 5,  0, 0, 20, 0, 0,0);
        ConstantsList.addToConstantsList(0, constants);
        WorldMap map = new WorldMap(0);
